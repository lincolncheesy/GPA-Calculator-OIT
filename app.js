      ...
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2">
          <button
            ...
            title="Official GPA Formula & computation breakdown"
          >
            <svg class="w-4 h-4 text-sky-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><path d="M12 17h.01"></path></svg>
            <span>Formula</span>
          </button>
          ...
          <button
            ...
            type="button"
            class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 transition cursor-pointer"
            title="Simulate target GPA for remaining modules"
          >
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-5 sm:p-6 mb-6">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        ...
        <div class="lg:col-span-5 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-200 pb-5 lg:pb-0 lg:pr-6">
          ...
          <div
            id="formula-pill-btn"
            class="mt-4 p-2.5 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-between text-xs cursor-pointer hover:bg-slate-100 transition group"
          >
  ...
  document.getElementById('target-modal-content').innerHTML = `
    ...
    <div class="flex items-center justify-between p-5 border-b border-slate-200 bg-slate-50">
      <div class="flex items-center gap-2.5">
        ...
        <div>
          <h2 class="text-lg font-bold text-slate-900">Target GPA Simulator &amp; Planner</h2>
